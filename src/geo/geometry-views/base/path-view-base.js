...
var PathViewBase = GeometryViewBase.extend({
  ...
  render: function () {
    ...
    this.mapView.addLayer(this._geometry);
  },
  ...
  _updatePathFromModel: function () {
    throw new Error('subclasses of PathViewBase must implement _updatePathFromModel');
  },

  clean: function () {
    GeometryViewBase.prototype.clean.call(this);
    this.mapView.removeLayer(this._geometry);
